...
class sslSms {
    private $api_token="ollhor9g-epkspydy-qb6wfohs-jtys0puv-lgaqzgng";
     ...
     * @param $csmsId (Unique)
     */
    public function singleSms($msisdn, $messageBody, $csmsId,$sid="CKCLBRAND"){
        $params = [
     ...
     * @param $batchCsmsId
     */
    public function bulkSms($msisdns, $messageBody, $batchCsmsId,$sid="CKCLBRAND"){
        $params = [
            "api_token" => $this->api_token,
            "sid" => $sid,
            "msisdn" => $msisdns,
     ...
     * @param $messageData
     */
    public function dynamicSms($messageData,$sid="CKCLBRAND"){
        $params = [
            "api_token" => $this->api_token,
            "sid" => $sid,
            "sms" => $messageData,
