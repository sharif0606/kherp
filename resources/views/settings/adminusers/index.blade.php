                    ...
                    <table class="table table-bordered mb-0">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>{{$p->email}}</td>
                                <td>{{$p->contact_no}}</td>
                                <td><img width="50px" src="{{asset('uploads/erpAdmin/'.$p->image)}}" alt=""></td>
                                ...
                                <td class="white-space-nowrap">
                                    ...
                                    <form id="form{{$p->id}}" onsubmit="return confirm('Are you sure?')" action="{{route(currentUser().'.admin.destroy',encryptor('encrypt',$p->id))}}" method="post">
                                        @csrf
                                        @method('delete')
                                    </form> --}}
                                </td>
